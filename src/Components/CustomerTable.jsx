...
import { AddCurrentCust, AddCurrentDest, AddIdCust } from '../Reducers/CustomerSlice';
                ...
                <tr key={cust.id}  >
                    <td>
                        <div className="name flex items-center space-x-3 py-[20px]">
                            ...
                            <p className='font-semibold text-[16px] 2xl:text-[18px]'>{cust.first_name}</p>
                        </div> 
                    </td>
                    <td className='font-semibold text-[16px] 2xl:text-[18px]'>{cust.last_name}</td>
                    <td className='font-semibold text-[16px] 2xl:text-[18px]'>{cust.email}</td>
                    <td className='font-semibold text-[16px] 2xl:text-[18px]'>{cust.phone}</td>
                    <td className='font-semibold text-[16px] 2xl:text-[18px]'>{cust.ip_address}</td>
                    <td>
                        <div className='flex flex-1 justify-end items-center'>
                            ...
                            }} className='py-3.5 px-5 text-sm font-medium rounded-md border-[1px] border-lighterGrey bg-white'>Shipments</Link>
                            <Link to='/' className='py-3.5 px-5 text-sm font-medium rounded-md bg-main-green ml-[19px] mr-[18px] text-white'>Edit</Link>
                        </div>
                    </td>     
                </tr>
                ))}
