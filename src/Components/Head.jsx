      ...
      <div className='w-[80%] md:w-[60%]  laptop:w-[100%]   flex items-center justify-end md:flex md:justify-between sm:justify-between   max-w-[1280px] laptop:mx-auto'>
        ...
        <div className='flex items-center'>
            ...
            <div className=' flex items-center space-x-1 ml-4 laptop:ml-12'>
                <img src={avatar} alt="avatar" className='w-[35px] h-[35px] laptop:w-[56px] laptop:h-[56px]' />
                <p className='hidden laptop:block text-[18px] font-semibold text-[#374151]'>Temoc</p>
                <img src={caret} alt="" />
              
            </div>
            {/* hamburger menu phone */}
            <div className='block laptop:hidden ml-8' onClick={()=>{
              dispatch(ShowNav(true))
              setFixed(true)
            }}>
            <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
               <path d="M26.25 22.5H3.75V20H26.25V22.5ZM26.25 16.25H3.75V13.75H26.25V16.25ZM26.25 10H3.75V7.5H26.25V10Z" fill="#3AB44A"/>
            </svg>
