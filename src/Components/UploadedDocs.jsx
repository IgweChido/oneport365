  ...
  return (
    <div>
      ...
      <div className='flex-col sm:flex-row sm:flex justify-between items-center mb-7'>
        {/* left */}
        <div>
          <p className='text-base font-semibold mb-7 sm:mb-0 text-[#6B7280]'>Uploaded Documents</p>
        </div>
        ...
        <div className='flex items-center gap-x-3'>
          ...
          {/* button 1 */}
          <button className='border border-gray rounded-md p-3.5 font-bold text-base text-[#374151]'>Request Document</button>
